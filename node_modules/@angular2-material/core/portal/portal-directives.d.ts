import { ComponentRef, TemplateRef, DynamicComponentLoader, ElementRef, ViewContainerRef } from 'angular2/core';
...
export declare class PortalHostDirective extends BasePortalHost {
    ...
    /** The attached portal. */
    private _portal;
    constructor(_dynamicComponentLoader: DynamicComponentLoader, _elementRef: ElementRef, _viewContainerRef: ViewContainerRef);
    portal: Portal<any>;
